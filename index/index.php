 ...
 <!-------
	<div class="page-wraper"> 
                        ...
                        <div class="clearfix">
                        	<div class="wt-topbar-left">
                           	    <ul class="list-unstyled e-p-bx pull-left">
                                    <li><i class="fa fa-envelope"></i>mailinfiniteelite</li>
                        	...
                        	<div class="wt-topbar-right">
                                ...
                                <li><a href="USER/login.php"><i class="fa fa-user"></i>Login</a></li>
                                    <li><a href="USER/signup.php"><i class="fa fa-sign-in"></i>Register</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="main-bar">
                    <div class="container">
                            ...
                            <div class="logo-header mostion">
                                <a href="index.html">
                                    <img src="infiiteone.jpeg" style="width:400px;height:75px;"  alt="" />
                                </a>
                            </div>
                                ...
                                <ul class=" nav navbar-nav">
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="cryp.php">CRYPTO</a></li>
                                            <li><a href="realestate.php">REAL ESTATE</a></li>
                                        </ul>
                                    </li>
                                
                                    <li>
                                        <a href="faq-1.php">FAQ</a>
        ...
        <div class="page-content">
                           ...
                           <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                                <ul>
                                    ...
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase;">
                                    	<span class="text-white" style="padding-right:10px;">Add crypto to your </span><span class="site-text-primary"></span>
                                    </div>
                                    ...
                                    border-width:0px;">
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase ;">
                                   		<span class="site-text-primary" style="padding-right:10px;">long-term investing strategy</span><span class="text-white"></span>
                                    </div>
                                    ...
                                    <a href="USER/login.php" class="site-button slider-btn-left">Get started</a>
                                    </div>
                                    ...
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">
                                    	<span class="text-white" style="padding-right:10px;">infiniteelite</span><span class="site-text-primary">Invest</span>
                                    </div>
                                    ...
                                    style="z-index:13; text-transform:uppercase;">
                                    <a href="login.php" class="site-button slider-btn-left">Get started</a>
                                    </div>
                                    ...
                                    color:#fff;
                                    border-width:0px;">
                                    <span style="font-family: 'Poppins', sans-serif;"><!---nothing here-----></span>
                                    </div>
                                    ...
                                    style="z-index:13; text-transform:uppercase;">
                                    <!-----<a href="javascript:;" class="site-button slider-btn-left"></a>------>
                                    </div>
                                    ...
                                    style="z-index: 13;">
                                   <!---<img src="images/cryptomovement.gif" alt="" width="300px" height="300px">--->
                                    </div>  
                                ...
                                <div class="row call-to-action-wrap">
                                    <div class="col-lg-9 col-md-12">
                                        <div class="call-to-action-left ">
                                            <h4 class="text-uppercase m-b10 font-weight-600">WHY CHOOSE US?</h4>
                                            <p>infiniteelite strives to be worthy of our client's trust by providing them with services which are economically beneficial to them and to create awareness regarding reliable and highly profitable investment platform among our clients around the globe. All you need to do is sit back and enjoy how your profit grows on a daily.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-9 m-b30">
                            <div class="wt-right-part">
                                ...
                                <div class="section-head text-left">
                                    <span class="wt-title-subline font-16 text-gray-dark m-b15">What is bitcoin currency trade</span>
                                    <h2 class="text-uppercase">Currency Bitcoin Trade</h2>
                                ...
                                <div class="section-content m-b60">
                                    <div class="wt-box">
                                        <p>
                                            <strong>we use the best possible crypto data to run simulations and backtest your trading or investing strategies. With data aggregated from hundreds of exchanges and thousands of coins, you can be sure that you're getting profits every single time.
                                            </strong>
                                        </p>
                                        <p>infiniteelite trade is a distinctive investment company offering our investors access to high-growth investment opportunities in Bitcoin markets and other services. We implement best practices of trading & mining of Bitcoins through our operations, while offering flexibility in our investment plans. Our company benefits from an extensive network of global clients.</p>
                                        <a href="login.php" class="site-button text-uppercase m-r15">login</a>
                                        <a href="services-1.php" class="site-button-secondry text-uppercase">services</a>
                                    </div>
                                </div>                                	
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 m-b30 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Quick funds access</h4>
                                        <p> Withdraw funds quickly and easily using a range of methods, without any hidden terms.
                            ...
                            <div class="col-lg-4 col-md-6 m-b30 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content ">
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Trade on the go</h4>
                                        <p>Trade your way with cryptny web app for mobile and desktop, or with our Android app.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 3 -->
                            <div class="col-lg-4 col-md-6 m-b30 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Segregated funds
</h4>
                            ...
                            <div class="col-lg-4 col-md-6 m-b30 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        <h4 class="wt-tilte text-uppercase font-weight-500">Amazing support
</h4>
                                        <p>Our highly skilled and dedicated support team are here to help with any currencies exchange whenever you need it.
                            ...
                            <div class="col-lg-4 col-md-6 m-b30 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>We are a digital assets trading and managment company, providing blockchain-backed investment products to investors, who wish to create financial stabilty and security through secure investing.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 6 -->
                            <div class="col-lg-4 col-md-6 m-b30 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        <h4 class="wt-tilte text-uppercase font-weight-500">$50 Cashback for new accounts</h4>
            ...
            <div class="section-full p-t80 p-b50 overlay-wraper bg-parallax clouds1 bg-repeat"  data-stellar-background-ratio="0.5" style="background-image:url(images/background/bg-9.jpg);">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 m-b30">
                            <div class="awesome-counter text-right text-white">
                                ...
                                <p>Advanced trading tools
Custom price alerts, advanced charts,
and more,Now you can build trading strategies and manage your crypto with our new suite of features – all in one place. Track market trends, plan advanced trades, set price alerts, and more.</p>
            ...
            <div class="section-full  p-t80 p-b50 bg-gray">
            	<div class="container">
                    ...
                    <div class="section-head text-center">
                        ...
                        <div class="wt-separator-outer"><div class="wt-separator site-bg-primary"></div></div>
                        <p>Explore diverse assets: stocks, bonds, ETFs, and more, for tailored trading experiences.</p>
                    </div>
                    <!-- TITLE END-->
                    <div class="section-content">
                            ...
                            <div class="col-lg-4 col-md-6 m-b30 step-number-block">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    ...
                                    <div class="icon-content">
                                        ...
                                        <p>Open Account for free in just a few minutes</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 2 -->
                            <div class="col-lg-4 col-md-6 m-b30 step-number-block">
                                <div class="wt-icon-box-wraper  p-a30 center bg-secondry m-a5 ">
                                    ...
                                    <div class="icon-content text-white">
                                        ...
                                        <h4 class="wt-tilte text-uppercase font-weight-500">FUND ACCOUNT</h4>
                                        <p>Login to account and make your deposit to activate your trade.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- COLUMNS 3 -->
                        ...
                        <div class="row">
                        	<div class="col-lg-6 col-md-12 m-b30 clearfix">
                            	<div class="bit-converter p-a40 bg-white">
                                	<div class="wt-box">
                                        ...
                                        <p>Real-Time Market Insights! Stay ahead of the curve with up-to-the-minute analysis, trends, and expert commentary. Empowering informed decision-making for your investment success.</p>
                                    </div>
                                	<div class="currency-calculator sp-one">
                                        <div style="width: 100%;">
                                            ...
                                            <script src="../../cdn.jsdelivr.net/gh/dejurin/crypto-converter-widget/dist/latest.min.js" async></script>
                                        </div>
                                    </div>
                                </div>                               
                            </div>
                            <div class="col-lg-6 col-md-12 m-b30">
                            	<div class="wt-box graph-part-right text-white">
                                	<strong class="text-uppercase title-first">infiniteelite</strong>
                                    <span class="text-uppercase site-text-primary display-block title-second">Maximum Profit & Secure Trading Platform</span>
                                    <p><strong>At the heart of our mission lies a steadfast commitment to fostering a secure trading platform that prioritizes the protection of our clients’ assets and sensitive information. Through the implementation of state-of-the-art security protocols and robust encryption methods, we ensure that every transaction conducted on our platform is shielded from potential threats and unauthorized access.</strong></p>
                                    <ul class="list-check-circle primary">
                                        <li>With encrypted protocols, your transactions are safeguarded,</li>
                                        <li>Tailored support and opportunities for investors worldwide</li>
                                        <li>ensuring seamless trading across international markets</li>
                                        <li>ensuring confidentiality and peace of mind</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container mt-3"  style="text-align:center;" id="pricing">
<h2 style="font-family:Georgia, 'Times New Roman', Times, serif;">INVESTMENT <span style="color:darkorange;"> PLANS</span></h2>
<h3 style="color:red;margin-bottom:1%;">Choose your preferable plan for investment</h3>
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card h-100">
      <div class="card-body"  style="text-align:center;background-color:#12203b;color:white;">
        <h5 class="card-title" style="color:darkorange;">INVEST INTO STARTER</h5>
        <p class="card-text">STARTING AT</p>
          <h5 style="color:white;">$1,000 - $10,000</h5>
          <p style="color:#B2BEB5;">Commission - 7 days<br/>
          Compound - 20%<br/>Capital Return - Yes<br/> Daily return - 350%<br/>Cancellation  - No<br/>
          Total Revenue - Infinity</p>
          <button class="btn btn-success" href="www.google.com">START INVESTING NOW</button>
      </div>
  ...
  <div class="col">
    <div class="card h-100">
      ...
      <div class="card-body" style="text-align:center;background-color:#12203b;color:white;">
      <h5 class="card-title" style="color:darkorange;" >INVEST INTO SILVER</h5>
        <p class="card-text">STARTING AT</p>
          <h5 style="color:white;">$10,000 - $30,000</h5>
          <p style="color:#B2BEB5;">Commission - 14 days<br/>
          Compound - 650%<br/>Capital Return - Yes<br/> Daily return - 350%<br/>Cancellation  - No<br/>
          Total Revenue - Infinity</p>
          <button class="btn btn-success" href="www.google.com">START INVESTING NOW</button>
      </div>
      <div class="card-footer">
  ...
  <div class="col">
    <div class="card h-100">
      ...
      <div class="card-body"  style="text-align:center;background-color:#12203b;color:white;" >
      <h5 class="card-title" style="color:darkorange;">INVEST INTO GOLD</h5>
        <p class="card-text">STARTING AT</p>
          <h5 style="color:white;">$30,000 - $100,000</h5>
          <p style="color:#B2BEB5;">Commission - 30 days<br/>
          Compound - 950%<br/>Capital Return - Yes<br/> Daily return - 350%<br/>Cancellation  - No<br/>
          Total Revenue - Infinity</p>
          <button class="btn btn-success"><a href="signup.php" style="text-decoration:none;">START INVESTING NOW</a></button>
      </div>
      <div class="card-footer">
        <small class="text-muted"></small>
      </div>
...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card h-100" style="border:none;">
      <div class="card-body"  style="text-align:center;background-color:#12203b;color:white;border-top-left-radius:70px; border-bottom-right-radius:70px;">
       
          <h2 class="mt-4" style="color:white;">$76 billion </h2>
          <p style="color:#B2BEB5;">24hrs trading volume on cryptny<br/>
          </p>
  ...
  <div class="card h-100" style="border:none;">
      <div class="card-body"  style="text-align:center;background-color:#12203b;color:white;border-top-left-radius:70px; border-bottom-right-radius:70px;">
          ...
          <h2 class="mt-4" style="color:white;">350+ </h2>
          <p style="color:#B2BEB5;">cryptocurrencies listed<br/>
          </p>
  ...
  <div class="card h-100" style="border:none;">
      <div class="card-body"  style="text-align:center;background-color:#12203b;color:white;border-top-left-radius:70px; border-bottom-right-radius:70px;">
          ...
          <h2 class="mt-4" style="color:white;">120 million </h2>
          <p style="color:#B2BEB5;">registered users<br/>
          </p>
                            	...
                            	<div class="section-content p-tb60 p-r30 clearfix">
                                	<div class="wt-left-part any-query">
                                    	...
                                    	<div class="text-center">
                                            ...
                                            <p class="text-white">Experience personalized support and expert investment advice. Whether you have inquiries</p>
                            	...
                            	<div class="section-content p-tb60 p-l30 clearfix">
                                    <div class="wt-right-part any-query-contact">
                                    	...
                                    	<div class="text-center">
                                            ...
                                            <p class="text-white">need assistance, or seek tailored guidance, we’re dedicated to helping you thrive in your financial journey</p>
                                            <h4 class="text-secondry m-b0">support@infiniteelite</h4>
                                        </div>                               
                                    </div>                                
                                </div>
                            </div>
...
<center>
<a id="cr-copyright" href="https://cryptorival.com/" target="_blank" rel="nofollow">Powered by company</a>
...
<!-- CryptoRival Calculator Widget END -->
            ...
            <div class="section-full tw-con-with-img bg-gray">
                <div class="overlay-wraper bg-center bg-cover bg-no-repeat  bg-gray" style="background-image:url(images/background/bg2.jpg)">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <div class="section-content p-tb70">
                                        ...
                                        <div class="contact-home-left">
                                            <form  class="cons-contact-form" method="post" action="https://thewebmax.org/bitinvest/form-handler2.php">
                                                <div class="row">
                        ...
                        <div class="owl-carousel home-carousel-1 m-b30">
                                ...
                                <div class="testimonial-5">
                                	<div class="testimonial-pic-block radius-bx"> 
                                    	<div class="testimonial-pic radius">
                                        	<img src="tt/naomi.jpg" width="132" height="132" alt="">
                                        </div>
                                    </div>
                                    <div class="testimonial-text clearfix">
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left site-text-primary"></span>
                                        <p>infiniteelite company is a great company, i love the customer support and transparency. quick payout
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
                                        <strong class="testimonial-name">Mary hover</strong>
                            ...
                            <div class="item">
                                <div class="testimonial-5">
                                	<div class="testimonial-pic-block radius-bx"> 
                                    	<div class="testimonial-pic radius">
                                        	<img src="tt/three.jpg" width="132" height="132" alt="">
                                        </div>
                                    </div>
                                    <div class="testimonial-text clearfix">
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left site-text-primary"></span>
                                        <p>of all the investment program i've done, infiniteelite is far the most reliable. the platform is so simple to use
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
                                        <strong class="testimonial-name">JAMES SMITH</strong>
                            ...
                            <div class="item">
                                <div class="testimonial-5">
                                	<div class="testimonial-pic-block radius-bx"> 
                                    	<div class="testimonial-pic radius">
                                        	<img src="tt/two.jpg" width="132" height="132" alt="">
                                        </div>
                                    </div>
                                    <div class="testimonial-text clearfix">
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left site-text-primary"></span>
                                        <p>i tried this investment company after my colleague introduced it to me, 
                                            and i must confess they're really helping me build wealth
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
                                        <strong class="testimonial-name">Michael toscano</strong>
                            ...
                            <div class="item">
                                <div class="testimonial-5">
                                	<div class="testimonial-pic-block radius-bx"> 
                                    	<div class="testimonial-pic radius">
                                        	<img src="tt/one.jpg" width="132" height="132" alt="">
                                        </div>
                                    </div>
                                    <div class="testimonial-text clearfix">
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left site-text-primary"></span>
                                        <p>i've been with two other investment programs, even though those  other are quite okay,infiniteelite is very diffrent than they are. you're reliable
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
                                        <strong class="testimonial-name">mrs.hilary philips</strong>
            ...
            <div class="section-full overlay-wraper bg-cover bg-repeat-x site-bg-primary" style="background-image:url(images/background/bg-7.png)">
                <div class="container">
