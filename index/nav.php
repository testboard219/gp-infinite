...
<html lang="en">
    <?php include_once "translator.php"; ?>


<!-- Mirrored from thewebmax.org/bitinvest/contact-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 May 2024 21:46:56 GMT -->
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Bit-invest Template | Contact </title>
            ...
            <div class="main-bar header-middle bg-black">
                <div class="container">
                    <div class="logo-header">
                        <a href="index.html">
                            <img src="infiiteone.jpeg" width="150" height="37" alt="" />
                        </a>
                    </div>
                        ...
                        <div class="header-nav navbar-collapse collapse ">
                            <ul class=" nav navbar-nav">
                                ...
                                <li class="submenu-direction">
                                    <a href="javascript:;">LEGAL<i class="fa fa-chevron-down"></i></a>
                                    <ul class="sub-menu">
                                        <li>
