...
//script mailer
 ...
 try {
     ...
     //Recipients
     $mail->setFrom('davesantan219@gmail.com', 'infinite-elite');
...
//script 
$id = $_SESSION['id'];
$statement=$pdo->prepare("INSERT INTO approvetable (email,fname,lname,number,country,date,ip,ballance,profit,bonus,id,plan,withdraw,password1,verification_code,verification_date,valuei,valued) VALUES (:email,:fname,:lname,:number,:country,:date,:ip,:ballance,:profit,:bonus,:id,:plan,:withdraw,:password1,:verification_code,:verification_date,:valuei,:valued)");
...
<body>
    ...
    <div class="container">
        ...
        <img  class="mb-4 logo-img" src="infiiteone.jpeg" href="index.html" style="width:200px;height: 80px; position:relative; top:10%;border-radius:10px;  border-top-left-radius:0px;">
    </div>
            </div>
...
<!---newly addeded 3/4/2024-->  <input type="hidden" class="form-control" name="valuei" value="0"><br>
<!---newly addeded 3/4/2024-->  <input type="hidden" class="form-control" name="valued" value="NULL"><br>
                ...
                <hr>
                <p style="text-align:center;"> © Copyright 2024  infiniteelite  All Rights Reserved.</p>
