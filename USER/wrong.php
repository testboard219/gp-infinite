...
<body>
    ...
    <div class="container">
        ...
        <img  class="mb-4 logo-img" src="logoxx.JPG" href="index.html" style="width:200px;height: 80px; position:relative; top:10%;border-radius:10px;  border-top-left-radius:0px;">
    </div>
            </div>
        <div class="row justify-content-center">
            ...
            <div class="col-sm-12 col-md-6 col-lg-5">
                ...
                <div class="form-group">
                        ...
                        <h3 class=" mb-5" style="color:#1a2255;"></h3></div>
                        ...
                        <label for="" class="inpu-label"><h5>kinly provide your right credentials </h5></label>
                        <div class="input-cnt">
                        ...
                        <input type="submit" name="takein" value="Try Again"  name='submit' class="btn btn-primary sce_nce">
