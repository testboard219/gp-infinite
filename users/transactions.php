    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <p>transactions</p>
                    <bold style="font-weight: bold;">ballance:</bold>$<?php echo $final_value;?><br><br>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-sm-12 col-md-6 col-lg-6">
      ...
      <p id="copy">bc1qd9nrc3st4vh6znt6ee694sqq2spw44zuqgr9ch</p>
...
if($amount > $bal){
  ...
  Swal.fire({
    icon: 'Error',
    title: 'you do not have sufficient ballance',
    text: 'kindly top up'
  });
  </script>";
