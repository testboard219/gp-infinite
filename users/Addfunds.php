...
<nav style="background-color:#061a39;">
        <div class="nav-bar" style="background-color:#061a39;">
            ...
            <!----</i>---
            <span class="logo navLogo"><img src="logomain.JPG" class="mt-1"  width="80" height="40" alt="..." style="border-radius: 10px;"></span>

            <div class="menu">
                <div class="logo-toggle">
                <span class="logo"><a href="#">CRYP<span style="color:darkcyan;">TNY</span></a></span>
...
<div class="card text-white bg-light mb-3" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <image src="tfrnd.jpg" width="200px" height="200px">
    

      <p id="copy" style="color: blue;" >35Gp3NmzAogzFGPBCWEDYYQbEo8vvxuCfx</p>
...
<div class="card text-white bg-light mb-3" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <image src="tfrnd.jpg" width="200px" height="200px">
      ...
      <p id="copyy" style="color: blue;" >35Gp3NmzAogzFGPBCWEDYYQbEo8vvxuCfx</p>
