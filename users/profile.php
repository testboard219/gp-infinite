...
<nav style="background-color:#061a39;">
        <div class="nav-bar" style="background-color:#061a39;">
            <!---<i class='bx bx-menu sidebarOpen' >----!close
            <i class="fa-solid fa-bars sidebarOpen"></i>
            <!----</i>---!closee
            <span class="logo navLogo"><img src="logomain.JPG" class="mt-1"  width="80" height="40" height="60" alt="..." style="border-radius: 10px;"></span>
